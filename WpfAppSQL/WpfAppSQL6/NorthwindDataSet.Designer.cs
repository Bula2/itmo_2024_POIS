...
namespace WpfAppSQL6.NorthwindDataSetTableAdapters {
...
SELECT OrderID, CustomerID, EmployeeID, OrderDate, RequiredDate, ShippedDate, ShipVia, Freight, ShipName, ShipAddress, ShipCity, ShipRegion, ShipPostalCode, ShipCountry FROM Orders WHERE (OrderID = SCOPE_IDENTITY())";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=GENIUS;Initial Catalog=Northwind;Integrated Security=True;Connect Tim" +
                "eout=30;Encrypt=True;TrustServerCertificate=True";
        }
